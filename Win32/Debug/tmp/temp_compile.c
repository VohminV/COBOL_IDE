...
#define  COB_MODULE_FORMATTED_DATE	"èþë 22 2025 11:30:04"
#define  COB_MODULE_DATE		20250722
#define  COB_MODULE_TIME		113004
...
static int		HelloWorld_ (const int);
static void		HelloWorld_module_init (cob_module *module);
...
HelloWorld ()
{
  return HelloWorld_ (0);
}

static int
HelloWorld_ (const int entry)
{
  ...
  /* Line: 4         : Entry     HelloWorld              : temp_compile.cbl */
  l_2:;
#line 4 "temp_compile.cbl"
  ENTRY_HELLOWORLD:	cob_nop ();
#line 105 "temp_compile.c"

  /* Line: 4         : DISPLAY            : temp_compile.cbl */
#line 4 "temp_compile.cbl"
  cob_nop ();
#line 110 "temp_compile.c"
  cob_display (0, 1, 1, &c_1);

  /* Line: 5         : STOP RUN           : temp_compile.cbl */
#line 5 "temp_compile.cbl"
  cob_nop ();
#line 116 "temp_compile.c"
  cob_stop_run (b_2);
...
/* End PROGRAM-ID 'HelloWorld' */

/* Initialize module structure for HelloWorld */
static void HelloWorld_module_init (cob_module *module)
{
  module->module_name = "HelloWorld";
  ...
  module->module_entry.funcptr = (void *(*)())HelloWorld;
  module->module_cancel.funcptr = (void *(*)())HelloWorld_;
